...
class singleChildClass(xbmcgui.WindowDialog):
	def __init__(self):
		#background
		self.addControl(xbmcgui.ControlImage(0,0,1275,750, '/home/vader/.xbmc/scripts/sourceMenu/8Icon/sourceBackground.jpg'))
		#Select an Input Text
		...
		self.strSourceInfo = xbmcgui.ControlLabel(63, 455, 200, 200, 'Checking...', 'font13', '0xFF000000')
		self.addControl(self.strSourceInfo)
	
		#Location and size of buttons
		self.button0 = xbmcgui.ControlButton(340, 260, 150, 150, "",focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTvaderButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/vaderButton2.jpg')
		self.addControl(self.button0)
	
		self.button1 = xbmcgui.ControlButton(490, 260, 150, 150, "", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTwidiButton1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/widiButton1.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button1)
	
		self.button2 = xbmcgui.ControlButton(640, 260, 150, 150, "APPLE TV 1", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTappleTV1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/appleTV1.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button2)
	
		self.button3 = xbmcgui.ControlButton(790, 260, 150, 150, "", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTwidiButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/widiButton2.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button3)
			
		self.button4 = xbmcgui.ControlButton(340, 410, 150, 150, "APPLE TV 2", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTappleTV2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/appleTV2.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button4)	
	
		self.button5 = xbmcgui.ControlButton(490, 410, 150, 150, "", textOffsetX=19, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTwindows1Button.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/windows1Button.jpg', textColor='0xFF000000',  focusedColor='0xFFFFFFFF')
		self.addControl(self.button5)

		self.button6 = xbmcgui.ControlButton(640, 410, 150, 150, "", textOffsetX=25, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTwindows2Button.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/windows2Button.jpg', textColor='0xFF000000',  focusedColor='0xFFFFFFFF')
		self.addControl(self.button6)

		self.button7 = xbmcgui.ControlButton(790, 410, 150, 150, "", textOffsetX=30, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTwindows3Button.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/windows3Button.jpg', textColor='0xFF000000',  focusedColor='0xFFFFFFFF')
		self.addControl(self.button7)

		self.button8 = xbmcgui.ControlButton(590, 570, 100, 30, "CANCEL", textOffsetX=17, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/cancelButton.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTcancelButton.jpg', textColor='0xFF000000',  focusedColor='0xFFFFFFFF')
		...
		self.button0.controlDown(self.button4)
		...
		self.button2.controlUp(self.button6)
		...
		self.button3.controlUp(self.button7)	
		...
		self.button4.controlLeft(self.button7)
		self.button4.controlUp(self.button0)

		#Windows 1 button
		self.button5.controlDown(self.button8)
		self.button5.controlRight(self.button6)
		self.button5.controlLeft(self.button4)
		self.button5.controlUp(self.button1)

		#Windows 2 button
		self.button6.controlDown(self.button8)
		...
		self.button7.controlRight(self.button4)
		self.button7.controlLeft(self.button6)
		self.button7.controlUp(self.button3)

		#Cancel button
		self.button8.controlDown(self.button0)
...
class multiChildClass(xbmcgui.WindowDialog):
	def __init__(self):
		...
		self.button2 = xbmcgui.ControlButton(640, 260, 150, 150, "", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTappleTV1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/appleTV1.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button2)
	
		self.button3 = xbmcgui.ControlButton(790, 260, 150, 150, "", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTwidiButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/widiButton2.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button3)
			
		self.button4 = xbmcgui.ControlButton(340, 410, 150, 150, "", textOffsetX=5, textOffsetY=10, focusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/FTappleTV2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/8Icon/appleTV2.jpg',textColor='0xFF000000', focusedColor='0xFFFFFFFF')
		self.addControl(self.button4)	
	...
	def getSourceInput(self):
		...
		source = foo[2]
		if source == '1':
			self.button8 = xbmcgui.ControlButton(63, 220, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton1.jpg')
			self.addControl(self.button8)    
			self.strSourceInfo1.setLabel('WiDi 1')
		elif source == '2':
			self.button8 = xbmcgui.ControlButton(63, 220, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV1.jpg')
			self.addControl(self.button8)   
			self.strSourceInfo1.setLabel('Apple TV 1')
		elif source == '3':
			self.button8 = xbmcgui.ControlButton(63, 220, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton2.jpg')
			self.addControl(self.button8)    
			self.strSourceInfo1.setLabel('WiDi 2')
		elif source == '4':
			self.button8 = xbmcgui.ControlButton(63, 220, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV2.jpg')
			self.addControl(self.button8)
			self.strSourceInfo1.setLabel('Apple TV 2')
		elif source == '5':
			self.button8 = xbmcgui.ControlButton(63, 220, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/vaderButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/vaderButton2.jpg')
			self.addControl(self.button8)
		...
		source = foo[2]
		if source == '1':
			self.button9 = xbmcgui.ControlButton(63, 350, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton1.jpg')
			self.addControl(self.button9)    
			self.strSourceInfo2.setLabel('WiDi 1')
		elif source == '2':
			self.button9 = xbmcgui.ControlButton(63, 350, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV1.jpg')
			self.addControl(self.button9)   
			self.strSourceInfo2.setLabel('Apple TV 1')
		elif source == '3':
			self.button9 = xbmcgui.ControlButton(63, 350, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton2.jpg')
			self.addControl(self.button9)    
			self.strSourceInfo2.setLabel('WiDi 2')
		elif source == '4':
			self.button9 = xbmcgui.ControlButton(63, 350, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV2.jpg')
			self.addControl(self.button9)
			self.strSourceInfo2.setLabel('Apple TV 2')
		elif source == '5':
			self.button9 = xbmcgui.ControlButton(63, 350, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/vaderButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/vaderButton2.jpg')
			self.addControl(self.button9)
		...
		source = foo[2]
		if source == '1':
			self.button10 = xbmcgui.ControlButton(63, 480, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton1.jpg')
			self.addControl(self.button10)    
			self.strSourceInfo3.setLabel('WiDi 1')
		elif source == '2':
			self.button10 = xbmcgui.ControlButton(63, 480, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV1.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV1.jpg')
			self.addControl(self.button10)   
			self.strSourceInfo3.setLabel('Apple TV 1')
		elif source == '3':
			self.button10 = xbmcgui.ControlButton(63, 480, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/widiButton2.jpg')
			self.addControl(self.button10)    
			self.strSourceInfo3.setLabel('WiDi 2')
		elif source == '4':
			self.button10 = xbmcgui.ControlButton(63, 480, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/appleTV2.jpg')
			self.addControl(self.button10)
			self.strSourceInfo3.setLabel('Apple TV 2')
		elif source == '5':
			self.button10 = xbmcgui.ControlButton(63, 480, 150, 100, "", focusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/vaderButton2.jpg', noFocusTexture='/home/vader/.xbmc/scripts/sourceMenu/6Icon/vaderButton2.jpg')
			self.addControl(self.button10)
